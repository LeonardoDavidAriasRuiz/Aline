//
//  VerifyNewEmail.swift
//  Aline
//
//  Created by Leonardo on 29/07/23.
//

import Foundation

struct VerifyNewEmail {
    let subject: String = "Nuevo correo electrónico"
    ...
    <html>
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>¡Estás a un paso de registrar el nuevo correo electrónico!</p>
